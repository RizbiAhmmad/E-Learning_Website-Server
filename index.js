  ...
  try {
    ...
    app.patch("/teach-applications/approve/:id", async (req, res) => {
      ...
      try {
        ...
        const application = await teachApplicationsCollection.findOne({
          _id: new ObjectId(id),
        });
        ...
        const updateApplicationResult =
          await teachApplicationsCollection.updateOne(
            { _id: new ObjectId(id) },
        ...
        res.send({
          ...
          message:
            "Application approved, and role updated to teacher in both databases.",
        });
      } catch (error) {
    ...
    app.post("/classes/:id/assignments", async (req, res) => {
      ...
      try {
        ...
        if (updateResult.modifiedCount > 0) {
          res.status(201).send({ message: "Assignment added successfully!" });
        } else {
